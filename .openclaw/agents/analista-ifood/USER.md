...
\### Wandson (consultor principal e fundador)
...
\- \*\*Como falar com ele:\*\* direto, sem formalidade. Pode chamar de "Wandson".
...
\- \*\*Como falar com ela:\*\* ainda calibrando. Por padrão, mesmo tom do Wandson.
...
\*\*Quem pode acessar todas as lojas:\*\* Wandson (admin).
