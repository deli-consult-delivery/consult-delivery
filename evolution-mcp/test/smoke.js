...
const EXPECTED_READ = ['evolution_status'];
...
check('McpServer registra todas as tools (SDK API + zod válidos)', () => {
  ...
  const evolution = new Proxy({}, { get: () => async () => ({}) });
