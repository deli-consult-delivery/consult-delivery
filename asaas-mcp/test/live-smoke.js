...
const { makeAsaasBridge } = require('../src/asaas-bridge');
const { makeSupabase } = require('../src/supabase');
const { makeAuditor } = require('../src/audit');
const { readTools } = require('../src/registry');

const LABEL = 'cd-asaas-mcp';
// Saldo e situação do mês são da conta da CD (sem tenant) — o Bridge usa o default.
const CALLS = [{ tool: 'asaas_saldo', args: {} }, { tool: 'asaas_situacao_mes', args: {} }];
