...
| `pipeline` | `PipelineScreen.jsx:373-380` | 200 | 186/24h (Consult, 93% do cap) | Perto de estourar, ordenação por `pipeline_position` antes de `created_at` pode descartar execuções recentes |
