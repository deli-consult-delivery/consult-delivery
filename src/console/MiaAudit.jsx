/**
 * MIA-04: Audit — logs de privacidade do worker MIA
 *
 * Console v2 nativo.
 * Acesso: admin apenas.
 *
...
const inp = { background: 'var(--panel)', border: '1px solid var(--line)', borderRadius: 4, padding: '8px 11px', fontSize: 13, outline: 'none', fontWeight: 500, color: 'var(--tx)', fontFamily: 'inherit', minWidth: 240 };
...
export default function MiaAudit({ tenantDbId, userId }) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      console.error('[MiaAudit]', err.message);
    } finally {
      setLoading(false);
    }
  }, [lojaId]);
